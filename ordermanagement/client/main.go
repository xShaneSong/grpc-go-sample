...
func main() {
	...
	if err := streamProcOrder.Send(&pb.Order{Id: "102"}); err != nil {
		log.Fatalf("%v.Send(%v) = %v", client, "102", err)
	}

	if err := streamProcOrder.Send(&pb.Order{Id: "103"}); err != nil {
		log.Fatalf("%v.Send(%v) = %v", client, "103", err)
	}

	if err := streamProcOrder.Send(&pb.Order{Id: "104"}); err != nil {
	...
	if err := streamProcOrder.Send(&pb.Order{Id: "101"}); err != nil {
